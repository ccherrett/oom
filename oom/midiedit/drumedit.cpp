...
void DrumEdit::load()
{
	...
	QString fn = getOpenFileName("drummaps", drum_map_file_pattern,
			this, tr("OOMidi: Load Drum Map"), 0);
	if (fn.isEmpty())
		return;
	bool popenFlag;
...
{
	pasteAction->setEnabled(QApplication::clipboard()->mimeData()->hasFormat(QString("text/x-oom-eventlist")));
}
