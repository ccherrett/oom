...
void initShortCuts()
{
	...
	// p4.0.10 Editors and arranger handle these by themselves, otherwise global handler will now use them, too.
        defShrt(SHRT_POS_INC, Qt::META + Qt::Key_Right, "Transport: Increase current position", GLOBAL_SHRT, "curpos_increase");
        defShrt(SHRT_POS_DEC, Qt::META + Qt::Key_Left, "Transport: Decrease current position", GLOBAL_SHRT, "curpos_decrease");
