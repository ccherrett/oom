...
public:
    ...
    SynthI* clone(bool /*cloneParts*/) const
    {
        return new SynthI(*this);
    }
    ...
    {
        return _sif->receiveEvent();
    }

    int eventsPending() const
    {
        return _sif->eventsPending();
    }
    void deactivate2();
    void deactivate3();
...
public:
    ...
    MessSynthIF(SynthI* s) : SynthIF(s)
    {
        _mess = 0;
    }
