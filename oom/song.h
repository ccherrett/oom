...
#define SC_MIDI_TRACK_PROP     0x8000001   // a midi track's properties changed (channel, compression etc)
#define SC_SONG_TYPE           0x8000002   // the midi song type (mtype) changed
#define SC_TRACKVIEW_INSERTED  0x8000003
#define SC_TRACKVIEW_REMOVED   0x8000004
#define SC_TRACKVIEW_MODIFIED  0x8000005
#define SC_PATCH_UPDATED       0X8000006
#define SC_VIEW_CHANGED		   0X8000007
#define SC_VIEW_ADDED		   0X8000008
#define SC_VIEW_DELETED		   0X8000009
